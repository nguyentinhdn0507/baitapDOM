...
let renderList = "";
const headerTitle = document.querySelector("#heading");
headerTitle.innerHTML = "Trang tin VinaEnter Edu";
const listNewsElement = document.querySelector("#list");
listNews.map((item) => {
  const { img, title, content } = item;
  renderList += `
    <li>
        <a href="#"><img src=${img} alt="h1.jpg" /></a>
        <div class="khoiphai">
...
listNewsElement.innerHTML = renderList;
